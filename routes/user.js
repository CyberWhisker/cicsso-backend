...
const {login, register, verifyUser, getUsers, getUserById, deleteData, updateData, getUsersWithAttendanceBySchedId, getUsersWithAttendance} = require('../controllers/UserController')
